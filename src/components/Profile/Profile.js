      ...
      <div className='container-fluid mt-5'>
        <div className='row text-center'>
          <div className='col-10 col-md-4 mt-5'>
            <div class='card p-2'>
              <div class='d-flex align-items-center'>
                <div class='image'><img src='./images/sanjay.jpg' alt=' ' class='rounded' width='155'/></div>
          ...
          <div className='col-10 col-md-4 mt-5'>
            <div class='card p-2'>
              <div class='d-flex align-items-center'>
                <div class='image'><img src='./images/Js.jpg' alt=' ' class='rounded' width='155'/></div>
                <div class='ml-3 w-100'>
          ...
          <div className='col-10 col-md-4 mt-5'>
            <div class='card p-2'>
              <div class='d-flex align-items-center'>
                <div class='image'><img src='./images/Harsshanth.jpg' alt=' ' class='rounded' width='155'/></div>
                <div class='ml-3 w-100'>
          ...
          <div className='col-10 col-md-4 mt-5'>
            <div class='card p-2'>
              <div class='d-flex align-items-center'>
                <div class='image'><img src='./images/shivani.jpg' alt=' ' class='rounded' width='155'/></div>
                <div class='ml-3 w-100'>
          ...
          <div className='col-10 col-md-4 mt-5'>
            <div class='card p-2'>
              <div class='d-flex align-items-center'>
                <div class='image'><img src='./images/Bhuvardhena.jpg' alt=' ' class='rounded' width='155'/></div>
                <div class='ml-3 w-100'>
          ...
          <div className='col-10 col-md-4 mt-5'>
            <div class='card p-2'>
              <div class='d-flex align-items-center'>
                <div class='image'><img src='./images/Ranjani.jpg' alt=' ' class='rounded' width='155'/></div>
                <div class='ml-3 w-100'>
